...
public class SellStockActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       */
        Button se = (Button)findViewById(R.id.sell);
        se.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText name = (EditText)findViewById(R.id.spersonNameText);
                EditText compName = (EditText)findViewById(R.id.scompanyNameText);
                EditText nuShares = (EditText)findViewById(R.id.snumSharesText);
       ...
       */
           ...
           */
                for (StockActivity s : t.keySet()) {
                    ...
                    if (s.companyAbb.equals(stockAbb)) {
                        ...
                        current.subtract(s.companyName, s.companyAbb, t.get(s).get(t.get(s).size() - 1).price, numShares, s);
                    }
                }
        ...
        Button home = (Button) findViewById(R.id.sstockh);
    ...
    private void sendData(HashMap<StockActivity, ArrayList<PriceActivity>>a,HashMap<String,StockPortfolioActivity>b){
       /*System.out.println("SelllllSTOCKKKKKKK");
